...
def get_complete_model():
    ...
    conv_base1 = Conv2D(256, kernel_size=(3,3), activation='relu', padding='same')(input_layer)
    conv_base1 = BatchNormalization()(conv_base1)
    conv_base1 = Dropout(0.40)(conv_base1)
    conv_base2 = Conv2D(256, kernel_size=(3,3), activation='relu', padding='same')(conv_base1)
    conv_base2 = BatchNormalization()(conv_base2)
    conv_base2 = Dropout(0.40)(conv_base2)
    conv_base3 = Conv2D(512, kernel_size=(1,1), activation='relu', padding='same')(conv_base2)
    conv_base3 = BatchNormalization()(conv_base3)  # Ensure normalization after each conv layer
    conv_base3 = Dropout(0.40)(conv_base3)
    ...
    conv_boxes = Conv2D(512, (3, 3), strides=(3, 3), activation='relu', padding='same')(input_layer)
    conv_boxes = BatchNormalization()(conv_boxes)

    # 1x9 convolutions for rows
    conv_rows = Conv2D(512, (1, 9), strides=(1, 1), activation='relu', padding='valid')(input_layer)
    conv_rows = BatchNormalization()(conv_rows)

    # 9x1 convolutions for columns
    conv_columns = Conv2D(512, (9, 1), strides=(1, 1), activation='relu', padding='valid')(input_layer)
